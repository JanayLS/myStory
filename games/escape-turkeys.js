function runTurkeyApocalypse() {
  ...
  /*
  <canvas id="gameCanvas" width="800" height="500" style="border:2px solid #000; background:#000;"></canvas>
  <div>
    <p>Survive the Turkey Apocalypse! Use arrow keys or W/S to move, SPACE or F to shoot.</p>
  </div>
